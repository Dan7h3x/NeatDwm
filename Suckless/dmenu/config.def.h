...
#if PANGO_PATCH
static char *font = "Pragmasevka Nerd Font 12";
#else
#if XRESOURCES_PATCH
static char *fonts[] =
#else
...
static Key global_esc = { XK_bracketleft, ControlMask };	/* escape key when vi mode is not enabled explicitly */
